...
VCF_DIR="/path/to/${tissue}/VCF_1KGimputed/VCF_merged"
...
# 1. Stage Data
cd "${LOCAL_DIR}"
INPUT_VCF="${VCF_DIR}/merged_chr${CHR_ID}.vcf.gz"
if [ ! -f "${INPUT_VCF}" ]; then
...
RSQ_VCF="merged_chr${CHR_ID}_rsq03.vcf.gz"
...
PLINK_OUT_PREFIX="merged_chr${CHR_ID}_filtered_rsq03"
plink2 --vcf "${RSQ_VCF}" \
